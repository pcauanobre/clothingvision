        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32">
          <div className="text-center space-y-8">
            ...
            <p className="text-xl md:text-2xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Estilo com inteligência: descubra peças únicas e receba a opinião de uma IA sobre estilo personalizada para você
            </p>
      ...
      <section className="py-24 bg-gray-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            {/* Coluna 1 - ESTILO */}
            <div>
              <h3 className="font-semibold text-white mb-4">ESTILO</h3>
              <p className="text-gray-300 text-sm">
                Sua loja de estilização com consultoria por IA.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <Link href="/catalogo" className="text-gray-300 hover:text-white text-sm transition-colors">
                    Catálogo
                  </Link>
                </li>
                <li>
          ...
          <div className="pt-8 border-t border-gray-700 text-center">
            <p className="text-gray-400 text-sm">
              © 2025 Estilo. Todos os direitos reservados.
            </p>
          </div>
        </div>
      </section>
